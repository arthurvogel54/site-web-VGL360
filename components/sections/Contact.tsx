        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            <p className="text-white/50 leading-relaxed mb-10 max-w-sm">
              Décrivez votre projet en quelques lignes. Je vous réponds dans les 24 heures
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                ...
                <span className="font-medium text-sm">easy.vgl360@gmail.com</span>
              </a>
              <a
              ...
              >
                ...
                <span className="font-medium text-sm">07 57 63 12 54</span>
              </a>
              <div className="flex items-center gap-4 text-white/60">
                ...
                <span className="font-medium text-sm">Toulouse, France</span>
              </div>
            </div>
            ...
            {status === 'sent' ? (
              <div className="h-full flex flex-col items-center justify-center text-center gap-6 bg-dark-DEFAULT border border-green-500/20 rounded-2xl p-12">
                ...
                <div>
                  ...
                  <p className="text-white/50 text-sm">Je vous réponds sous 24 heures. À très vite !</p>
                </div>
              </div>
            ) : (
              <form
